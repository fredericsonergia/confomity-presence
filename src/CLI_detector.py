...
class Predictor(object):
    ...
    def eval(
        ...
        save_prefix="ssd_512_test2",
        model_path="models/ssd_512_best.params",
        taux_fp=0.05,
        save_plot=True,
        results_folder="results_ROC/",
        log_folder="logs/",
    ):
        """
        ...
        """
        detector = ModelBasedDetector.from_finetuned(
            model_path, data_path_test=data_path_test, save_prefix=save_prefix
        )
        detector._set_tests()
