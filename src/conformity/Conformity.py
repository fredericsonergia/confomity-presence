...
class Conformity:
    ...
    def check_orthogonality(self)-> dict:
        ...
        ruler_vector_start_end = (ruler_end_point[0] - ruler_start_point[0], ruler_end_point[1] - ruler_start_point[1])
        protection_vector_end_start = (protection_start_point[0] - protection_end_point[0],protection_start_point[1] - protection_end_point[1])
        #ruler_vector_start_end=(0,1)
        #protection_vector_end_start=(-1,0)
        intersection_angle = angle_betw_2_vects(protection_vector_end_start, ruler_vector_start_end)
    ...
    def get_conformity(self) -> dict:
        ...
        if self.__conformity == None:
            if not self.__protection.check_protection():
                ...
                self.__conformity = {"type":"error", "message":"Votre réglette n'est pas assez perpendiculaire avec la protection."}
            else:
