...
class CliDetectorTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.detector = ModelBasedDetector.from_pretrained(
            data_path_test="tests/test_data/detector_data/EAF_test",
            data_path="tests/test_data/detector_data/EAF_test",
            batch_size=10,
    ...
    #   print(epochs, ce_loss_list, ce_loss_val, smooth_loss_list, smooth_loss_val, map_list)
    #   self.assertNotEqual(len(epochs), 0)
    #   self.assertNotEqual(ce_loss_list, [])
    #   self.assertNotEqual(ce_loss_val, [])
    #   self.assertNotEqual(smooth_loss_list, [])
    #   self.assertNotEqual(smooth_loss_val, [])
