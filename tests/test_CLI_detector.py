...
class CliDetectorTestCase(unittest.TestCase):
    def setUp(self):
        ...
        if os.path.exists("tests/test_data/detector_data/results_train"):
            for f in os.listdir("tests/test_data/detector_data/results_train"):
                os.remove(
                    os.path.join("tests/test_data/detector_data/results_train", f)
                )
        ...
        self.detector1 = ModelBasedDetector.from_pretrained(
            data_path_test="tests/test_data/detector_data/for_test",
            data_path="tests/test_data/detector_data/for_test",
            batch_size=10,
    ...
    def test_train_from_pretrained(self):
        ...
        plot_train(
            ...
            map_list,
            "test",
            "tests/test_data/detector_data/results_train/",
        )
    ...
    def test_eval(self):
        ...
        self.detector2.eval(
            0.5,
            True,
            "tests/test_data/detector_data/results/",
            "tests/test_data/detector_data/logs/",
        )
        name_log = os.listdir("tests/test_data/detector_data/logs/")
    ...
    def test_predict(self):
        score, prediction, box_coord = self.detector2.predict(
            "tests/test_data/detector_data/images_test/EAF17.jpg",
