...
class CliDetectorTestCase(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.detector = ModelBasedDetector.from_pretrained(data_path_test='tests/test_data/detector_data/EAF_test', data_path='tests/test_data/detector_data/EAF_test', batch_size=10, base_model='ssd_512_mobilenet1.0_custom', save_prefix='test')
